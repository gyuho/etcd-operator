...
type GCSContext struct {
	// KeyName is the key name of GCS.
	KeyName string
	// JSONKey is a Google Developers service account JSON key file.
	// Create/Download from https://console.cloud.google.com/apis/credentials.
	JSONKey []byte
